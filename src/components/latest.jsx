            ...
            <div>
                <div className="container mx-auto px-4 py-8">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div className="md:col-span-2 md:row-span-2 relative overflow-hidden shadow-lg">
                            <div className="w-full h-full bg-gray-300 animate-pulse"></div>
                        </div>

                        {/* Loading skeleton - Two small items */}
                        ...
                        {/* Loading skeleton - Three medium items */}
                        <div className="relative overflow-hidden shadow-lg">
                            <div className="w-full h-48 bg-gray-300 animate-pulse"></div>
                        </div>
                        <div className="relative overflow-hidden shadow-lg">
                        ...
                        <div className="md:col-span-2 relative overflow-hidden shadow-lg">
                            <div className="w-full h-48 bg-gray-300 animate-pulse"></div>
                        </div>
                        <div className="relative overflow-hidden shadow-lg">
                            <div className="w-full h-48 bg-gray-300 animate-pulse"></div>
        ...
        <div >
            <div className="container mx-auto px-4 py-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div className="md:col-span-2 relative overflow-hidden shadow-lg group">
                        <img src="https://images.unsplash.com/photo-1553778263-73a83bab9b0c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHw1fHxmb290YmFsbHxlbnwwfDB8fHwxNzIxMDQzMjExfDA&ixlib=rb-4.0.3&q=80&w=1080" alt="Sport" className="w-full h-48 object-cover" />
                        <div className="absolute inset-0 bg-black bg-opacity-60 opacity-0 group-hover:opacity-70 transition-opacity duration-300">
                            <div className="absolute bottom-0 left-0 right-0 p-4">
                                <h4 className="text-xl font-bold text-white">Football</h4>
