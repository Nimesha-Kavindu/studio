    ...
    return (
        <>
            ...
            <div className="w-full min-h-screen flex flex-col lg:flex-row bg-white">
                <div className="w-full lg:w-1/2 h-full p-8 lg:p-16 lg:pl-32 lg:pr-16">
                    <h2 className="text-3xl font-mono mb-8 text-gray-800 tracking-widest">ARANTHA ~ SIRIMANNE</h2>
                    ...
                    <img src="https://aranthaphotography.com/wp-content/uploads/2016/05/Arantha-Sign.jpg" alt="Signature" className="mt-8 mb-6" />
                ...
                <div className="w-full lg:w-1/2 h-96 lg:h-145 relative lg:fixed lg:bottom-0 lg:right-0 bg-gray-100">
                    <img 
